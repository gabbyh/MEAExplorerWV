...
namespace PluginMorph
{
    public class MorphStaticExtended : MorphStaticAsset
    {
        ...
        public MorphStaticExtended(MemoryStream resStream) : base(resStream)
        {
            PresetMesh = "N/A";
        }
        
        public MorphStaticExtended(MemoryStream resStream, MemoryStream ebxStream) : base (resStream) 
        {
